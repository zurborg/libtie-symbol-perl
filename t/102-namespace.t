...
is $def2->parent->namespace => 'main::abc', '(def2) parent of main::abc::def is main::abc';
is $def2->parent->parent->namespace => 'main', '(def2) parent of main::abc is main';
is $def2->parent->parent->parent => undef, '(def2) main has not parent';

is $def3->parent->namespace => 'main::abc', '(def3) parent of main::abc::def is main::abc';
is $def3->parent->parent->namespace => 'main', '(def3) parent of main::abc is main';
